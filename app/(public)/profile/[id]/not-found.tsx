...
import { ExclamationTriangleIcon, HomeIcon, UserCircleIcon } from "@heroicons/react/24/outline";
                    ...
                    <div className="relative z-10 p-8 md:p-12">
                        ...
                        <div className="text-center mb-8 space-y-2">
                            ...
                            <p className="text-mirage-600">
                                Es posible que el enlace esté roto o que este usuario ya no forme parte de la plataforma.
                            </p>
                        </div>
