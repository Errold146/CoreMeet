...
import { DeleteConnectForm } from "./DeleteConnectForm";

export function DeleteConnectModal() {

    const { open, setOpen, connect, setConnect } = useCoreConnectStore()
                            ...
                            <div className="w-full">
                                ...
                                <div className="space-y-4">
                                    <p className="text-mirage-700 text-sm leading-relaxed">
                                        ¿Confirmas que deseas eliminar este CoreConnect?
                                        <span className="font-semibold text-red-600"> Esta acción es irreversible</span> y
                                        no se podrá recuperar la información ni los registros de asistentes.
                                    </p>
