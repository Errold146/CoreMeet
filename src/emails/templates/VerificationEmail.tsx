        ...
        <html>
            ...
            <body>
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                    <h1>Bienvenido a CoreMeet</h1>
                    <p>Hola <strong>${data.name}</strong>,</p>
                    <p>Has creado tu cuenta en CoreMeet. Ya está casi todo listo, solo debes confirmar tu cuenta.</p>
...
export function renderVerificationEmailText(
    ...
    return `
        ...
        Has creado tu cuenta en CoreMeet. Para confirmar tu cuenta, visita el siguiente enlace:
